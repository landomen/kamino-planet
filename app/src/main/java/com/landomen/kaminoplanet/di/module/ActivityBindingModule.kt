...
import com.landomen.kaminoplanet.presentation.resident.details.module.ResidentDetailActivityModule
...
abstract class ActivityBindingModule {
    ...
    @PerActivity
    @ContributesAndroidInjector(modules = [ResidentDetailActivityModule::class])
    abstract fun residentDetailActivity(): ResidentDetailActivity
}